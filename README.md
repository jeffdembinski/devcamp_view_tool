...
This is a copyright tool to make sure your content has the proper copyright each year. 
...
```ruby
DevcampViewTool::Renderer.copyright 'Jeff Dembinski', 'All Rights Reserved'
```
